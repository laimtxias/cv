...
\begin{center}
  ...
  {\color{accent}\itshape\large Ingénieure en IA Générative \& Développement Backend -- IMT Mines Albi}\\[6pt]
  {\small
    Grenoble, France
    \,\textbullet\,
...
\sectionrule
\justifying
Ingénieure diplômée de l'IMT Mines Albi (Data \& Systèmes d'Information), avec une expérience concrète de développement de services d'IA générative en production : APIs backend (FastAPI), pipelines RAG, orchestration de LLM et agents IA. En recherche d'un poste d'ingénieure IA à partir de septembre 2026.
...
\cvexp{Stagiaire Assistante Ingénieure R\&D}{Yooz}{Aimargues, France}{Avril 2025 -- Août 2025 (4 mois)}{%
  \begin{itemize}[leftmargin=12pt, itemsep=2pt, topsep=0pt, partopsep=0pt, parsep=0pt]
    \item Application web (Dash, Plotly) de visualisation d'embeddings (PCA, t-SNE, UMAP, K-Means) pour analyser et catégoriser les erreurs d'un moteur de recherche sémantique (Milvus) sur factures réelles.
