...
\newcommand{\sidebarcert}[2]{%
  \textbf{\small #1} {\itshape\color{graytext}\footnotesize (#2)}\\[2pt]
}
...
\sectionrule
\justifying
Ingénieure diplômée de l'IMT Mines Albi, option Génie des systèmes d'information. En recherche d'un poste d'ingénieure en intelligence artificielle à partir de septembre 2026.
...
\cvexp{Stagiaire Ingénieure IA Générative}{ALTEN Lab}{Grenoble, France}{Février 2026 -- Août 2026 (6 mois)}{%
  \begin{itemize}[leftmargin=12pt, itemsep=2pt, topsep=0pt, partopsep=0pt, parsep=0pt]
    ...
    \item Benchmark d'outils d'extraction PDF (Docling, PyMuPDF, OCR, VLM), pipeline d'ingestion (chunking, embeddings, pgvector) et deux moteurs RAG complémentaires (frameworkless, LangChain/LangGraph).
...
\sidebarline{Languages}{Python (NumPy, Pandas, Scikit-learn, TensorFlow/PyTorch), R, SQL, C++, Matlab}
...
% ---------- LANGUES ----------
\subsectitle{Langues}
{\small Anglais (TOEIC 965 pts), Espagnol, Japonais}
...
{\small Volley (2 ans en compétition)}\\
