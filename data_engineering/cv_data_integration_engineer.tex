...
\sectionrule
\justifying
Ingénieure diplômée de l'IMT Mines Albi, option Génie des systèmes d'information. En recherche d'un poste d'ingénieure Data à partir de septembre 2026.
...
\cvexp{Stagiaire Ingénieure IA Générative}{ALTEN Lab}{Grenoble, France}{Février 2026 -- Août 2026 (6 mois)}{%
  \begin{itemize}[leftmargin=12pt, itemsep=2pt, topsep=0pt, partopsep=0pt, parsep=0pt]
    ...
    \item Conception d'un pipeline d'ingestion et d'indexation de données (chunking, embeddings, pgvector) et de deux moteurs de traitement complémentaires (frameworkless, LangChain/\allowbreak LangGraph).
...
\cvexp{Stagiaire Assistante Ingénieure R\&D}{Yooz}{Aimargues, France}{Avril 2025 -- Août 2025 (4 mois)}{%
  \begin{itemize}[leftmargin=12pt, itemsep=2pt, topsep=0pt, partopsep=0pt, parsep=0pt]
    \item Intégration de bases de données NoSQL (Milvus, ChromaDB) dans un pipeline de recherche en production, avec Git pour la gestion de version.
    \item Application web (Dash) de visualisation des flux de données et d'expérimentation de solutions IA pour la gestion comptable, en dialogue direct avec les équipes métier.
...
\sidebarline{Data \& Intégration}{Pipelines de données, API (FastAPI), bases NoSQL, Git}
\sidebarline{Outils}{Docker, CI/CD}
