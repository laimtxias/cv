...
\cvexp{Stagiaire Ingénieure IA Générative}{ALTEN Lab}{Grenoble, France}{Février 2026 -- Août 2026 (6 mois)}{%
  \begin{itemize}[leftmargin=12pt, itemsep=2pt, topsep=0pt, partopsep=0pt, parsep=0pt]
    \item Cycle complet du projet (état de l'art, recueil du besoin métier, traitement des données, mise en production) d'une solution de recherche documentaire industrielle, conçue pour être adaptable à différents métiers.
...
\cvexp{Stagiaire Assistante Ingénieure R\&D}{Yooz}{Aimargues, France}{Avril 2025 -- Août 2025 (4 mois)}{%
  \begin{itemize}[leftmargin=12pt, itemsep=2pt, topsep=0pt, partopsep=0pt, parsep=0pt]
    \item Intégration de bases de données NoSQL (Milvus, ChromaDB) dans un pipeline de données en production, avec Git pour la gestion de version.
    \item Application web (Dash) de visualisation des flux de données pour la gestion comptable, en dialogue direct avec les équipes métier.
...
\sidebarline{Data Engineering}{Pipelines de données, bases relationnelles \& NoSQL, API (FastAPI), Git}
